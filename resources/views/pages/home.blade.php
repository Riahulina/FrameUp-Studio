...
<section class="py-24 bg-navy relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        'icon' => '📸',
        'title' => 'Sesi Photobox',
        'desc' => 'Foto seru di photobox dengan berbagai pilihan background dan properti unik.',
        'num' => '01'
        ],
        [
        'icon' => '🎭',
        'title' => 'Properti & Aksesoris',
        'desc' => 'Berbagai props lucu seperti kacamata, topi, papan kata-kata, dan lainnya.',
        'num' => '02'
        ],
        [
        'icon' => '🖨️',
        'title' => 'Cetak Instan',
        'desc' => 'Hasil foto langsung dicetak dengan kualitas tinggi dalam hitungan detik.',
        'num' => '03'
        ],
        [
        'icon' => '🎨',
        'title' => 'Custom Frame',
        'desc' => 'Pilih desain frame sesuai tema acara atau keinginan kamu.',
        'num' => '04'
        ],
        [
        'icon' => '📂',
        'title' => 'File Digital',
        'desc' => 'Dapatkan hasil foto dalam bentuk digital untuk disimpan atau dibagikan.',
        'num' => '05'
        ],
        [
        'icon' => '🎉',
        'title' => 'Event & Party',
        'desc' => 'Layanan photobox untuk ulang tahun, wedding, dan berbagai event spesial.',
        'num' => '06'
        ],
        ];
        @endphp
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card-hover reveal  group cursor-pointer">
...
============================================================ --}}
<style>
    .works-btn:hover .works-btn-fill {
        transform: scale(2);
    }
...
<script>
    (function() {
        ...
        if (pb) {
            pb.style.width = (pb.getAttribute('data-init-width') || '14.28') + '%';
        }
        ...
        origSlides.slice(-CLONES).map(function(n) {
            return n.cloneNode(true);
        }).forEach(function(c) {
            track.prepend(c);
        });
        origSlides.slice(0, CLONES).map(function(n) {
            return n.cloneNode(true);
        }).forEach(function(c) {
            track.append(c);
        });
